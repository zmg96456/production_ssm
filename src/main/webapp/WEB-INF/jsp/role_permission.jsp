...
<div style="padding:10px 10px 10px 10px">
	<form id="permissionForm" class="itemForm" method="post"> 
		...
		<label><input name="permissionOption" type="checkbox" value="281" />角色新增 </label> 
		<label><input name="permissionOption" type="checkbox" value="282" />角色修改 </label> 
		<label><input name="permissionOption" type="checkbox" value="283" />角色删除 </label> 
		<br><br>
			<br>
	</form>
